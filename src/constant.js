...
const Constant = {
     ...
     stronlypath: '\nPath : ',
     strend: '     ',
     PROGRESS_MSG: 'Please wait until OpenAPI spec generation is being processed for the \'%s\' %s',
     PROGRESS_MSG_ENTIRE_PROJECT: "Please wait until OpenAPI spec testing is being processed for the entire project.",
     STR_PACKAGE: 'package',
     STR_DIAGRAM: 'diagram',
     ...
     title_import_mi_1: "Please wait until model interchange is being processed for the \'",
