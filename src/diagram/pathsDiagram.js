...
/**
 * @class PathsDiagram
 * @description class returns the PathsDiagram
 */
class PathsDiagram {
     /**
      * @constructor Creates an instance of PathsDiagram.
      */
     constructor() {
     ...
     getOperations() {
          ...
          try {
               ...
               let interReal = diagramEle.getUMLInterfaceRealization();
               diagramEle.getUMLInterface().forEach(objOperation => {
                    ...
                    if (filterInterface.length > 0) {
                         ...
                         console.log("MyConsole",objInterface);
